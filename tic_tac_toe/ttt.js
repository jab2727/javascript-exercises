...
function winChecker(){
    let winCheck = false;
    if (gameBoard.MM !== "" && ((gameBoard.MM == gameBoard.TM && gameBoard.MM == gameBoard.BM) ||
        ...
        winCheck = true;
    } else if (gameBoard.TL !== "" && ((gameBoard.TL == gameBoard.TM && gameBoard.TL == gameBoard.TR) ||
                                (gameBoard.TL == gameBoard.ML && gameBoard.TL == gameBoard.BL))){
        winCheck = true;
    } else if   (gameBoard.BR !== "" && ((gameBoard.BR == gameBoard.TR && gameBoard.BR == gameBoard.MR) ||
