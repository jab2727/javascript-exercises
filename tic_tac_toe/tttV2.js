function gameBoard() {
    ...
    const winChecker = () => {
        let winCheck = false;
        if (board.MM !== "" && ((board.MM == board.TM && board.MM == board.BM) ||
                                    (board.MM == board.ML && board.MM == board.MR) ||
                                    (board.MM == board.TL && board.MM == board.BR) ||
                                    (board.MM == board.TR && board.MM == board.BL))){
            winCheck = true;
        } else if (board.TL !== "" && ((board.TL == board.TM && board.TL == board.TR) ||
                                    (board.TL == board.ML && board.TL == board.BL))){
            winCheck = true;
        } else if   (board.BR !== "" && ((board.BR == board.TR && board.BR == board.MR) ||
