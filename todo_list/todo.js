class ToDo{
    ...
    toDoToStorage = function() {
        ...
        const toAdd = {project: this.project, description: this.description, due : this.dueDate, priority: this.priority};
...
let newTodoButton = document.getElementById("project-title");
let ProjectNameList = [];
...
newProjectButton.addEventListener("click", () => newProject(prompt("Enter new project name:")));



function newProject(newProjectName){
    const nameCheck = ProjectNameList.filter(newName => newName == newProjectName);
...
document.getElementById("submit").addEventListener("click", function() {
    let a = activeProjectName;
    let b = document.getElementById('description').value;
    document.getElementById('description').reset;
    let c = document.getElementById('dueDate').value;
    document.getElementById('dueDate').reset;
    let d = document.querySelector('input[name="priority"]:checked').value;
...
function activeProjectTodoListUpdater(){
    ...
    let oldTodos = document.getElementsByClassName("generated");
